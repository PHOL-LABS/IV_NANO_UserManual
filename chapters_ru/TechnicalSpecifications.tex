...
\noindent\textbf{Заводские пресеты и совместимые датчики}\label{tab:sensor-characteristics}\\
...
\textbf{Индикатор} & \textbf{Датчик} & \textbf{Питание} & \textbf{Примечания} \\
...
\noindent\textbf{Совместимость датчиков температуры масла/охлаждающей жидкости}\label{tab:oil-coolant-sensors}\\
...
\textbf{Совместимый датчик} & \textbf{Сигнал/питание} & \textbf{Параметры калибровки} \\
...
\noindent\textbf{Совместимость датчиков температуры воздуха}\label{tab:air-temperature-sensors}\\
...
Датчик наружной температуры MFA (VAG \texttt{171 919 379 A}, Golf Mk2/Jetta II/Passat B2/B3) & 2-проводной NTC, плавающий &
    Диапазон отображения примерно от $-40^\circ$C до $+96^\circ$C. Эмпирическая калибровка: $R_{25} \approx 510~\Omega$, $\beta \approx 3400$--3500~K (подгонка между $+4^\circ$C и $+50^\circ$C). Диагностическая точка: 200~$\Omega \approx +50^\circ$C. Корпус разъёма \texttt{1J0973802}; ответная часть \texttt{1J0973702}. \\
...
\noindent\textbf{Совместимость датчиков давления масла}\label{tab:oil-pressure-sensors}\\
...
\noindent\textbf{Совместимость датчиков уровня топлива}\label{tab:fuel-level-sensors}\\
...
\noindent\textbf{Совместимость датчиков давления наддува}\label{tab:boost-pressure-sensors}\\
...
\noindent\textbf{Совместимость контроллеров широкополосной лямбды}\label{tab:wideband-lambda}\\
