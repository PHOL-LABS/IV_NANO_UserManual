...
\begin{figure}[p]
    ...
    \caption{Установка индикатора температуры}
\end{figure}
\clearpage
...
\begin{figure}[p]
    ...
    \caption{Установка широкополосного лямбда-индикатора}
\end{figure}
\clearpage
...
\begin{figure}[p]
    ...
    \caption{Пример установки индикатора наддува}
\end{figure}
\clearpage
