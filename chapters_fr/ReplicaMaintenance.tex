...
\begin{figure}[p]
    ...
    \caption{Vue d'ensemble du câblage lambda}
\end{figure}
\clearpage
...
\begin{figure}[p]
    ...
    \caption{Exemple de connexion large bande}
\end{figure}
\clearpage
...
\begin{figure}[p]
    ...
    \caption{Affectation des broches du contrôleur vers la LSU~4.9}
\end{figure}
\clearpage
...
\begin{figure}[p]
    ...
    \caption{Détail de connexion IV-Indicator}
\end{figure}
\clearpage
...
\begin{figure}[p]
    ...
    \caption{Exemple d'installation terminée}
\end{figure}
\clearpage
