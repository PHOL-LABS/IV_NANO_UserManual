...
\noindent\textbf{Préréglages d'usine et capteurs compatibles}\label{tab:sensor-characteristics}\\
...
\textbf{Indicateur} & \textbf{Capteur} & \textbf{Alimentation} & \textbf{Remarques} \\
...
\noindent\textbf{Compatibilité des capteurs de température d'huile/liquide de refroidissement}\label{tab:oil-coolant-sensors}\\
...
\textbf{Capteur compatible} & \textbf{Signal/alimentation} & \textbf{Paramètres d'étalonnage} \\
...
\noindent\textbf{Compatibilité des capteurs de température d'air}\label{tab:air-temperature-sensors}\\
...
Sonde de température extérieure MFA (VAG \texttt{171 919 379 A}, Golf Mk2/Jetta II/Passat B2/B3) & NTC à 2 fils, flottant &
    Plage d'affichage approximative de $-40^\circ$C à $+96^\circ$C. Étalonnage empirique : $R_{25} \approx 510~\Omega$, $\beta \approx 3400$--3500~K (ajusté entre $+4^\circ$C et $+50^\circ$C). Référence de diagnostic : 200~$\Omega \approx +50^\circ$C. Boîtier de connecteur \texttt{1J0973802} ; connecteur accouplé \texttt{1J0973702}. \\
...
\noindent\textbf{Compatibilité des capteurs de pression d'huile}\label{tab:oil-pressure-sensors}\\
...
\noindent\textbf{Compatibilité des capteurs de niveau de carburant}\label{tab:fuel-level-sensors}\\
...
\noindent\textbf{Compatibilité des capteurs de pression de suralimentation}\label{tab:boost-pressure-sensors}\\
...
\noindent\textbf{Compatibilité des contrôleurs lambda large bande}\label{tab:wideband-lambda}\\
